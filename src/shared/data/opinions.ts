    ...
    pl: [
        {
            ...
            source:
                'https://smogathon.com/pl/smogaton-2019-hackathon-z-wykorzystaniem-danych/',
            sourceName: 'smogathon.com.pl',
        },
        {
            text:
                ...
                'satelitarnych oraz sztucznej inteligencji.”',
            source:
                'https://firma.rp.pl/biznes/4431-nowe-technologie-dla-srodowiska-znamy-laureatow-smogathonu-2019',
            sourceName: 'firma.rp.pl',
        },
    ],
    en: [
        {
